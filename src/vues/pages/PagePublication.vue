<template>
    <GabaritPublication>
        <template slot="header">
            ...
            <VuePublicationDetails v-if="!!publication" :publication="publication"></VuePublicationDetails>
        </template>
        <template slot="sub">
            <VuePublicationReponseFormulaire></VuePublicationReponseFormulaire>
        </template>
        <VuePublicationReponses :publicationReponses="publicationReponses"></VuePublicationReponses>
