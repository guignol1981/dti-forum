...
export class PublicationReponseService implements RestService<PublicationReponse> {
  ...
  public modifier(publicationReponse: PublicationReponse): Promise<PublicationReponse> {
    return this.httpService
      .execute<PublicationReponse>({
        method: 'put',
